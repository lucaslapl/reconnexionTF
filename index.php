...
<body>
    ...
    <header id="accueil">
       ...
       <?php require_once '_inc/actualites.php'; ?>
    ...
    <?php require_once '_inc/presentation.php'; ?>

    <?php require_once '_inc/partners.php'; ?>

    <?php require_once '_inc/servers.php'; ?>
